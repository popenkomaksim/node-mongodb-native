# NOTE: THE 2.X VERSION OF THE DRIVER IS DEPRECATED, AND IS NO LONGE SUPPORTED. YOU CAN FIND THE LATEST VERSION OF THE DRIVER [HERE](https://github.com/mongodb/node-mongodb-native/)
